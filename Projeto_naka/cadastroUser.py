...
from cadastroAgendamento import CadastroAgendamento
...
class CadastroUsuario:
    ...
    def __init__(self):
        ...
        self.tela.pbAgendamento.clicked.connect(self.abrirTelaAgendamento)
        self.tela.pbAgendamento.setEnabled(True)
    ...
    def abrirTelaAgendamento(self):
        self.telaAgendamento = CadastroAgendamento()
